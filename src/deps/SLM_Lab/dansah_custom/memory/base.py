...
from deps.SLM_Lab.slm_lab.lib import logger
...
class Memory(ABC):
    ...
    def __init__(self, memory_spec, body):
        ...
        self.data_keys = ['states', 'actions', 'rewards', 'next_states', 'dones', 'rfts', 'priorities']  # NOTE: Added "rfts" (reason for termination(s)), @dansah
