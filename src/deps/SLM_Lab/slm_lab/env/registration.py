...
def try_register_env(spec):
    ...
    try:
        ...
        elif env_name.startswith('Furuta'):
            # TODO: Allow additional arguments, perhaps.
            real_name = spec['env'][0]['real_name']
            register(
                id=env_name,
                entry_point='custom_envs.%s:FurutaPendulumEnvPaper' % real_name,
                kwargs={})
