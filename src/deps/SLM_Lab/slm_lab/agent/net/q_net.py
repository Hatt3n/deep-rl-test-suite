...
from deps.SLM_Lab.slm_lab.agent.net.base import Net
from deps.SLM_Lab.slm_lab.agent.net.conv import ConvNet
from deps.SLM_Lab.slm_lab.agent.net.mlp import MLPNet
