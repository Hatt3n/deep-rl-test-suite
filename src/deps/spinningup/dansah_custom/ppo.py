...
import gym
import time
import deps.spinningup.dansah_custom.ppo_core as core
...
class PPOBuffer:
    ...
    def get(self):
        ...
        #### Trying FIX ####
        if adv_std == np.float32(0):
            adv_std = np.float32(1)
        #### End of FIX ####
...
def ppo(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
    ...
    Args:
        ...
        epochs (int): Number of epochs of interaction (equivalent to
            ...
            NOTE: This value is ignored if min_env_interactions is non-zero.
        
        min_env_interactions (int): The minimum number of interactions with the environment
            to perform before stopping training.
            NOTE: Added by dansah.
