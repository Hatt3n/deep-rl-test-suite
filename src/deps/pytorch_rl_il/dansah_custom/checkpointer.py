...
class PeriodicCheckpointer(Checkpointer):
    ...
    def __call__(self, enforce=False):
        # save pereodically
        ...
        if self._writer.train_steps % self.frequency == 0 or enforce:
            print("NOTE: Model saved, at %s sampled frames." % get_writer().sample_frames)
