...
def get_experiment(exp_name):
    ...
    elif exp_name == "spec1": # [64_relu, 64_64_relu, 64_64_tanh, 256_128_relu, 400_300_relu] for [a2c_s, dqn, reinforce]
        envs_to_use = ["cartpole"]
        algorithms_to_use = ["a2c_s", "dqn", "reinforce"]
        architecture_to_use = ["64_relu", "64_64_relu", "64_64_tanh", "256_128_relu", "400_300_relu"]
        seeds = [0, 10, 100, 1000]
    elif exp_name == "spec2": # [256_128_relu] for [a2c_s_adam]
        envs_to_use = ["cartpole"]
        algorithms_to_use = ["a2c_s_adam"]
        architecture_to_use = ["256_128_relu"]
        seeds = [0, 10, 100, 1000]
    elif exp_name == "spec3": # [64_relu, 64_64_relu, 64_64_tanh] for [reinforce, a2c_s]
        envs_to_use = ["furuta_paper"]
        algorithms_to_use = ["a2c_s", "reinforce"]
        architecture_to_use = ["64_relu", "64_64_relu", "64_64_tanh"]
        seeds = [0, 10, 1000]
    elif exp_name == "spec4": # [64_64_relu, 256_128_relu] for [ddpg, reinforce]
        envs_to_use = ["furuta_pbrs"]
        algorithms_to_use = ["ddpg", "reinforce"]
        architecture_to_use = ["64_64_relu", "256_128_relu"]
        seeds = [0, 10, 100, 1000]
    elif exp_name == "spec5": # [64_64_relu] for [ddpg, reinforce]
        envs_to_use = ["furuta_pbrs2"]
        algorithms_to_use = ["ddpg", "reinforce"]
        architecture_to_use = ["64_64_relu"]
        seeds = [0, 10, 100, 1000]
    elif exp_name == "spec6": # [64_64_tanh, 64_64_relu, 256_128_relu] for [ddpg, reinforce, ppo, ppo_s]
        envs_to_use = ["furuta_pbrs3"]
        algorithms_to_use = ["ddpg", "reinforce", "ppo", "ppo_s"]
        architecture_to_use = ["64_64_tanh", "64_64_relu", "256_128_relu"]
        seeds = [0, 10, 100, 1000]
